...
**Rubric:** [`../../canon/principles/golden-rules.md`](../../canon/principles/golden-rules.md) · **Read the scoring philosophy
first:** [`README.md`](./README.md) (we are *not* chasing 100% everywhere).

**Scored against:** a V3 draft ([`../../delivery/migration-v2-to-v3.md`](../../delivery/migration-v2-to-v3.md),
...
Almost none of V3 is built. Only an **additive graft-on-kill prototype (slice 1)**
ships; its `+1`/added-suit semantics were corrected on 2026-06-20 to rank-or-suit
replacement and are now delivery drift. The relic-tree
...
- **Why:** Built on proven Regicide combat; the V3 loop
  ...
  [`depth-width-elegance.md`](../../canon/principles/depth-width-elegance.md).)
...
- **Why:** Minor (rank/suit replacement graft) and major (loophole × recruit × cascade) already
...
- **What caps it:** A large slice of the live token catalog is still `+1/+2`
  (Hone/Temper/levers), and the implemented redundant-kill slice still incorrectly
  uses Hone/add-suit semantics. Continent-2 pressure is intentionally **numerical**
...
- **Why:** A conquered royal means different things to Executioner vs Surgeon; grafts
  replace rank or suit; **your relic set is the context** that reweights every card.
