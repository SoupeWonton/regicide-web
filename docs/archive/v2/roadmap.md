...
- **Step 5 (token economy / Forge) is BUILT + tested (smoke Test E), and the flag
  ...
  [`open-design-questions.md`](open-design-questions.md) → Q10.
...
[`open-design-questions.md`](open-design-questions.md)). Continent 2
...
- **Specialization trees** ([`proposals/specialization-trees.md`](proposals/specialization-trees.md))
