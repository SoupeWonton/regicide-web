...
status: current
authority: derived
topics: [deck, persistence, attrition]
search_terms: [Kingfall persistent deck, Tavern discard hand, deck between fights, Hearts recovery, rest]
sources: [canon/v3/constraints.md, canon/v3/campaign/run-and-progression.md, decisions/2026-06-20-five-act-continuous-expedition.md, proposals/systems/deck-lifecycle.md, proposals/open-design-questions.md, research/strategy/additional-strategy.md]
aliases: [Continuous Deck]
...
A long run may punish a weak trajectory, but it must reveal a comeback or end promptly. [[v3/stages/duration-and-fairness|Death fairness]] and lifecycle recovery are therefore one design problem rather than separate tuning topics. (sources: [[canon/v3/campaign/run-and-progression|Run and progression]], [[proposals/systems/deck-lifecycle|Deck lifecycle packet]])

## Confirmed design

Hand, Tavern, discard, conquered cards, grafts, and expedition consequences continue between road encounters. Only explicit rests reshuffle and redraw; save/resume does not create a separate run. (sources: [[canon/v3/constraints|V3 constraints]], [[canon/v3/campaign/run-and-progression|Run and progression]])

## Not yet decided

Rest placement, act-boundary recovery, Hearts-versus-landmark recovery, collapse detection, and exact comeback tools remain open. (source: [[proposals/open-design-questions|Active design questions]])
