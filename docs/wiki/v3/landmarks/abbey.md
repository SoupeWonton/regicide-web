...
Any future Abbey must respect [[v3/mechanics/items-and-power-vehicles|spell removal]], [[v3/mechanics/deck-lifecycle|open curation]], and [[v3/landmarks/camp|Camp's]] ownership of full rest. Its strongest current value is historical: it shows why a location needs a unique verb rather than a differently themed reward screen. (sources: [[delivery/migration-v2-to-v3|Migration specification]], [[canon/principles/content-bar|Content bar]])
