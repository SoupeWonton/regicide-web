...
status: current
authority: derived
topics: [campaign, death, meta-progression]
search_terms: [Kingfall death, run reset, unlocks, meta progression, permanent upgrades]
sources: [canon/v3/campaign/run-and-progression.md, decisions/2026-06-20-five-act-continuous-expedition.md, proposals/classes/facets-and-pressure-permutations.md, proposals/lore/context-lore.md]
aliases: [Meta Progression]
...
Breadth must create new plans rather than mandatory stat power that compensates for an underdeveloped core loop. (source: [[canon/v3/campaign/run-and-progression|Run and progression]])

Breadth can mean another class or facet, faction, relic package, route, tradeoff-based start, expert shortcut, or pressure permutation. Offer size should remain bounded so unlocking more possibilities never means stacking more simultaneous power. (sources: [[canon/v3/campaign/run-and-progression|Run and progression]], [[proposals/classes/facets-and-pressure-permutations|Facets and pressures]])
...
Exact unlocks, triggers, factions, facet offers, relic packages, routes, shortcuts, challenge permutations, and their fictional representation remain open. (source: [[canon/v3/campaign/run-and-progression|Run and progression]])
