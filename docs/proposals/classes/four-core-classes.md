...
This document proposes one linear progression per class. A competing exploratory model
with one invariant loophole plus mutually exclusive facets is developed in
[`facets-and-pressure-permutations.md`](facets-and-pressure-permutations.md). Only the
four loop identities in canonical [`overview.md`](../../canon/v3/classes/overview.md)
