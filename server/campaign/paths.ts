...
export const STAFFS: StaffDef[] = [
  ...
  { id: 'reinforce', classId: 'sentinel', name: 'Reinforce',
    text: 'Your combos may include ONE Spade of adjacent rank (±1), still under the combo limit.' },
  ...
  { id: 'parry', classId: 'sentinel', name: 'Parry', activated: true, usesCard: true,
    text: 'Once per enemy, while paying a counterattack: play a Spade from hand as emergency shield (its value reduces the payment; the card is spent).' },
  // Executioner — Kill
  ...
  { id: 'ace-in-the-hole', classId: 'quartermaster', name: 'Ace in the Hole',
    text: 'Your Aces copy the RANK of the card they pair with (auto: prefers the total that lands an exact kill).' },
  ...
  { id: 'triage', classId: 'surgeon', name: 'Triage',
    text: 'Your recoveries return the HIGHEST-value cards from the discard (instead of the oldest).' },
  { id: 'last-rites', classId: 'surgeon', name: 'Last Rites',
    text: 'Once per enemy: the best card of your recovery goes straight to your HAND instead of the Tavern.' },
